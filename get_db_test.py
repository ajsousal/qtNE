...
#     full_entry = os.path.join(data_dir,entry)
#     if os.path.isdir(full_entry):
#         subfolders.append(full_entry) # or full_entry

# active_subfolder = subfolders[0]
# databases = []
# for entry in os.listdir(active_subfolder):
#     if entry.endswith('.db'):
#         databases.append(entry)

# active_database = databases[0]
# location_db = os.path.join(active_subfolder,active_database)
# # qc.initialise_or_create_database_at(location_db)
# connection_db = connect(location_db)
