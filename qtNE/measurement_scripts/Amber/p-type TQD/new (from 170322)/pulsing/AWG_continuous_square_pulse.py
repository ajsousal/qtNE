...
def inf_pulse(instrument):
    ...
    twait = 10e-9 #600e-9#*10 for oscilloscope visualization  # first wait time (s)
    tblock= 1e-6 # *10 for oscilloscope visualization
    ...
    high_level_LB = 6.0 * 1e-3 * MF_IV # 2000 * 1e-3# 2250 * 1e-3  # the high level (V)
    high_level_RB = 0 * 1e-3 * MF_III #-350 * 1e-3 # 2000 * 1e-3 # the high level (V)
    ...
    baseshape_LB.insertSegment(0, ramp, (-high_level_LB/2, -high_level_LB/2), dur=twait)
    baseshape_LB.insertSegment(1, ramp, (high_level_LB/2, high_level_LB/2), dur=tblock)
    baseshape_LB.insertSegment(2, ramp, (-high_level_LB/2, -high_level_LB/2), dur=tinter)
