...
high_level_RB = -250 * 1e-3 # 2000 * 1e-3# 2250 * 1e-3  # the high level (V)
high_level_LB = 0 #-350 * 1e-3 # 2000 * 1e-3 # the high level (V)
...
# baseshape_pulse.insertSegment(0, ramp, (0, 0), dur=twait+(tblock-tdrive))
...
baseshape_pulse.insertSegment(1, ramp, (high_level_pulse, high_level_pulse), dur=tdrive)
baseshape_pulse.insertSegment(2, ramp, (0, 0), dur=tblock-tdrive+tinter)
baseshape_pulse.setSR(SR)
