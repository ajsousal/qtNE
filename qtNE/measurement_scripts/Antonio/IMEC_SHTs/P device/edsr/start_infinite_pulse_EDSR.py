...
def inf_pulse(instrument):
    ...
    tblock= 200e-9#*10 for oscilloscope visualization
    ...
    high_level_RB = 0 * 1e-3 # 2000 * 1e-3# 2250 * 1e-3  # the high level (V)
    high_level_LB = 0 * 1e-3 #-350 * 1e-3 # 2000 * 1e-3 # the high level (V)
    ...
    SR = 1.2e9
    high_level_pulse = 1.0  # the high level (V) - for pulse modulation
