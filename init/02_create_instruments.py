...
# from custom_drivers.MokuPro import MokuScope
...
# station.load_config_file('parameters_config.yml')
...
# ivvi = IVVI(name='ivvi', dac_step=10, dac_delay=0, address='COM3', numdacs=16, polarity = ['BIP', 'BIP', 'BIP', 'POS'], use_locks=False)
...
# keithley1 = Keithley2000.Keithley_2000(name='keith1', address='GPIB0::18::INSTR')
# station.add_component(keithley1)



# ip_address = '[fe80::7269:79ff:feb0:74c]'
# mokuscope = MokuScope(name='mokuscope',address = ip_address)
# station.add_component(mokuscope)
