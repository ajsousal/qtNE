...
from .helpers.pyqtgraph_helper.pyqtgraph import QtPlot

try:
    from .helpers import procstyles_db as procstyles
except:
...
from .helpers import plot_tools

from .helpers import db_comms

try:
    from .windows.dataviewmeta import DataMeta
    from .windows.dataviewprocess import DataProc
    from .windows.dataviewfunctions import DataFuncs
except:
    from .windows.dataviewmeta import DataMeta
    from .windows.dataviewprocess import DataProc
    from .windows.dataviewfunctions_db import DataFuncs
